...
Included is the Sketch to be uploaded to the Attiny85. It was taken from (and renamed for clarity) the open source "Arduino Component Sketches-master" folder, subtitled "ACS-85 ATTiny85 sketches" code written by Rob Stave .
